...
for i=3:length(Files)
    ...
    VolSB(i-2)=median(d.^1.5); %median cell volume in each image
...
VSE(1)=1.28^3 * 4/3*sqrt(pi)*mean(AreaSE1.^1.5);
VSE(2)=1.28^3 * 4/3*sqrt(pi)*mean(AreaSE2.^1.5);
VSE(3)=1.28^3 * 4/3*sqrt(pi)*mean(AreaSE3.^1.5);
VSE(4)=1.28^3 * 4/3*sqrt(pi)*mean(AreaSE4.^1.5);
VSE(5)=1.28^3 * 4/3*sqrt(pi)*mean(AreaSE5.^1.5);
VSE(6)=1.28^3 * 4/3*sqrt(pi)*mean(AreaSE6.^1.5);

VCE(1)=1.28^3 * 4/3*sqrt(pi)*mean(AreaCE1.^1.5);
VCE(2)=1.28^3 * 4/3*sqrt(pi)*mean(AreaCE2.^1.5);
VCE(3)=1.28^3 * 4/3*sqrt(pi)*mean(AreaCE3.^1.5);
VCE(4)=1.28^3 * 4/3*sqrt(pi)*mean(AreaCE4.^1.5);
VCE(5)=1.28^3 * 4/3*sqrt(pi)*mean(AreaCE5.^1.5);
VCE(6)=1.28^3 * 4/3*sqrt(pi)*mean(AreaCE6.^1.5);
...
['SE, #cells: ' num2str(round(mean(NumSE))) ' +- ' num2str(round(std(NumSE)/sqrt(89)))]
...
plot(median(AreaSE1.^1.5),WeightSE(1),'bo')
plot(median(AreaSE2.^1.5),WeightSE(2),'bo')
plot(median(AreaSE3.^1.5),WeightSE(3),'bo')
plot(median(AreaSE4.^1.5),WeightSE(4),'bo')
plot(median(AreaSE5.^1.5),WeightSE(5),'bo')
plot(median(AreaSE6.^1.5),WeightSE(6),'bo')

plot(median(AreaCE1.^1.5),WeightCE(1),'ro')
plot(median(AreaCE2.^1.5),WeightCE(2),'ro')
plot(median(AreaCE3.^1.5),WeightCE(3),'ro')
plot(median(AreaCE4.^1.5),WeightCE(4),'ro')
plot(median(AreaCE5.^1.5),WeightCE(5),'ro')
plot(median(AreaCE6.^1.5),WeightCE(6),'ro')
